...
if TEST_FULL
    ...
    filename = strcat('synGP/figs2/synGP_full.pdf');
...
filename = strcat('synGP/figs2/synGP_compositeEigenGP_M', int2str(M), '.pdf');
saveas(gcf, filename, 'pdf');
...
filename = strcat('synGP/figs2/synGP_kerB_M', int2str(M), '.pdf');
saveas(gcf, filename, 'pdf');
...
filename = strcat('synGP/figs2/synGP_fitc_M', int2str(M), '.pdf');
saveas(gcf, filename, 'pdf');
%% SSGPR
seed = 1;
rand('seed',seed); randn('seed',seed);
...
plotResult(x, y, xtest, ytest, x(1+n:n+ns), pred_mu, pred_s2);
filename = strcat('synGP/figs2/synGP_ssgpr_M', int2str(M), '.pdf');
saveas(gcf, filename, 'pdf');
